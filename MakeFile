study.exe: Naturvidenskab.o Humaniora.o Teknisk.o Samfund.o utility.o Sundhed.o fakultet.o main.c
	gcc -o study -ansi -Wall -pedantic Naturvidenskab.o Humaniora.o Teknisk.o Samfund.o utility.o Sundhed.o fakultet.o main.c
...
fakultet.o: fakultet.c fakultet.h
	gcc -c -ansi -Wall -pedantic fakultet.c 
